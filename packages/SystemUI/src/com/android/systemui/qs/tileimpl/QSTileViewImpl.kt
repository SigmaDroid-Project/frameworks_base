...
open class QSTileViewImpl @JvmOverloads constructor(
    ...
    private val colorOffstate = Utils.getColorAttrDefaultColor(context, R.color.qs_color_inactive)
    private val colorActive = Utils.getColorStateListDefaultColor(
            context, R.color.qs_color_accent_primary)
    private val colorInactive = if (isA11Style) Utils.applyAlpha(INACTIVE_ALPHA, colorOffstate) else Utils.getColorStateListDefaultColor(context, R.color.qs_color_inactive)
    ...
    private val colorLabelInactive =
            Utils.getColorAttrDefaultColor(context, if (isA11Style) com.android.internal.R.attr.textColorSecondary else R.color.qs_color_text_inactive)
    ...
    private val colorSecondaryLabelActive =
            Utils.getColorAttrDefaultColor(context, if (isA11Style) com.android.internal.R.attr.textColorSecondary else R.color.qs_color_text_active);
    private val colorSecondaryLabelInactive =
            Utils.getColorAttrDefaultColor(context, if (isA11Style) com.android.internal.R.attr.textColorTertiary else R.color.qs_color_text_inactive)
